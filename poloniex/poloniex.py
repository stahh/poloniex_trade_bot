...
def _api_wrapper(fn):
    """API function decorator that performs rate
    limiting and error checking."""
...
class PoloniexPublic:
    ...
    def __init__(self, public_url=_PUBLIC_URL):
    ...
    def _public(self, command, **params):
        ...
        with self.session() as sess:
            response = sess.get(self._public_url, params=params)
        return response
...
class Poloniex(PoloniexPublic):
    ...
    class _PoloniexAuth(auth.AuthBase):
    ...
    def __init__(self, apikey=None, secret=None,
        ...
        super(Poloniex, self).__init__(public_url)
    ...
    def returnOrderStatus(self, orderNumber):
        return self._private('returnOrderStatus', orderNumber=orderNumber)
